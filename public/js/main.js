...
async function boot() {
  ...
  // sensor — exactly the kind of premature technical interruption the
  // ritual is designed to avoid. It runs instead the first time the dev
  // panel is opened (see openDevPanel below), which is an explicit,
